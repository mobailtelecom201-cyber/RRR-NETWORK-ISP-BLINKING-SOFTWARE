...
$count_query = "SELECT COUNT(*) as total FROM sms_logs";
$total = $conn->query($count_query)->fetch_assoc()['total'];
$pages = ceil($total / $limit);

$query = "SELECT * FROM sms_logs ORDER BY id DESC LIMIT $offset, $limit";
$result = $conn->query($query);
$sms_logs = $result->fetch_all(MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>SMS Management - <?php echo APP_NAME; ?></title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 sidebar">
                ...
                <a href="../../admin/sms/index.php" class="active"><i class="fas fa-sms"></i> SMS</a>
            ...
            <div class="col-md-10 p-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="send.php" class="btn btn-sm btn-light"><i class="fas fa-envelope"></i> Send SMS</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($sms_logs as $log): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                $badge_class = $log['status'] === 'Sent' ? 'success' : ($log['status'] === 'Delivered' ? 'info' : 'warning');
                                                ?>
                                                <span class="badge bg-<?php echo $badge_class; ?>"><?php echo $log['status']; ?></span>
                                            </td>
                                            <td><?php echo formatDate($log['created_at'], 'Y-m-d H:i'); ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
